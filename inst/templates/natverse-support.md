...
Thanks for using {{{ package }}}. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the {{{package}}} package](https://github.com/natverse/{{{package}}}/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/{{{package}}}/issues/new).
* If you're not sure:
